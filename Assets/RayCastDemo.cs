...
public class RayCastDemo : MonoBehaviour {
	...
	void	DrawCrossHairs (Vector3 vLocation) {
		Vector3	tA = new Vector3 (vLocation.x - 0.5f, vLocation.y - 0.5f, 0.0f);
		Vector3	tB = new Vector3 (vLocation.x + 0.5f, vLocation.y - 0.5f, 0.0f);
		Vector3	tC = new Vector3 (vLocation.x + 0.5f, vLocation.y + 0.5f, 0.0f);
		Vector3	tD = new Vector3 (vLocation.x - 0.5f, vLocation.y + 0.5f, 0.0f);
